// src/App.jsx - UPDATED WITH SERVICES AND TEAM MEMBERS ROUTES
...
import AdminServices from './pages/admin/Services'; // <-- NEW IMPORT
import AdminTeamMembers from './pages/admin/Teammembers'; // <-- NEW IMPORT
    ...
    <AuthProvider>
      <Router>
        ...
        <Routes>
          ...
          {/* NEW: Team Members Management Route */}
          <Route
            path="/admin/team-members"
            element={
              <PrivateRoute allowedRoles={['admin', 'super_admin', 'editor']}>
                <AdminLayout><AdminTeamMembers /></AdminLayout>
              </PrivateRoute>
            }
          />
