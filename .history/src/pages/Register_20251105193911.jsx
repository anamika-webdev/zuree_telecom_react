...
const Register = () => {
  ...
  const { registerUser } = useAuth(); // Get register function from context
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // We only need loginId and password for the API
      await registerUser({
      ...
      // Display the error message from the API (e.g., "User already exists")
