// =====================================================
// ADMIN JOBS/CAREERS MANAGEMENT ROUTES - COMPLETE VERSION
// File: zuree_telecom_api/routes/admin/jobs.js
// =====================================================
...
router.delete('/:id', verifyToken, async (req, res) => {
  try {
    ...
    // Delete job (applications will be cascaded if foreign key set)
...
router.patch('/:id/status', verifyToken, async (req, res) => {
  try {
    ...
    // Log activity
    await logActivity(pool, req.adminId, 'update_status', id, `Changed job status to: ${status}`);
